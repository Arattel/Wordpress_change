...
Plugin URI: http://webmire.com/cms/wordpress-plugins/alphaomega-captcha-anti-spam/
...
Author URI: http://webmire.com/cms/wordpress-plugins/alphaomega-captcha-anti-spam/
License: GPL2
*/
...
function aokato ( $kola, $selida ) {
    ...
    if ( $selida == plugin_basename(__FILE__) && function_exists( 'admin_url' ) ) {
        ...
        $ftiaxe = '<a href="http://webmire.com/cms/wordpress-plugins/alphaomega-captcha-anti-spam/donate.html">' . __('Please Donate') . '</a>';
