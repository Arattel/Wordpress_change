...
<div class="as-info-block" id="as_updatehistory_section">
    <div class="as-tabs-horizontal">
        <div class="as-info-heading">
            <ul>
                <li><a href="#as_update_history"><i class="fa fa-refresh"></i><?php _e('Update History', 'avartan-slider-lite'); ?></a></li>
                <li><a href="#as_system_info"><i class="fa fa-info-circle"></i><?php _e('System Info', 'avartan-slider-lite'); ?></a></li>
            </ul>
        </div>
