        ...
        <div class='as-tabs-content'>
            <div id='as_tab_source_settings' class="as-tab-info">
                ...
                <div class="as-form-control-group as-bgtype-solidColor">
                    ...
                    <div class="as-form-control">
                        <input type="text" value="<?php echo $bgcolor; ?>" class="as-slide-bgcolor as-color-picker" data-alpha="true" data-custom-width="0" />
                    </div>
                ...
                <div class="as-bgtype-gradientColor">
                    ...
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control as-pro-color">
                            <input type="text" readonly="readonly" value="<?php echo $detColor1; ?>" class="as-slide-gradientColor as-color-picker" data-alpha="true" data-custom-width="0" />
                        </div>
                    ...
                    <div class="as-form-control-group as-gradient-block">
                        <label>&nbsp;</label>
                        <div class="as-form-control as-pro-color">
                            <input type="text" value="<?php echo $detColor2; ?>" readonly="readonly" class="as-slide-gradientColor as-color-picker" data-alpha="true" data-custom-width="0" />
                            <button class="as-add-bgGradient as-pro-version"><i class="fa fa-plus"></i></button>
                        </div>
                    </div>
                    <?php
                    if (isset($bgcolorArr) && count($bgcolorArr) > 2) {
                        for ($i = 2; $i < count($bgcolorArr); $i++) {
                            ...
                            <div class="as-form-control-group as-gradient-block">
                                <label>&nbsp;</label>
                                <div class="as-form-control as-pro-color">
                                    <input type="text" value="<?php echo $bgcolorArr[$i]; ?>" readonly="readonly" class="as-slide-gradientColor as-color-picker" data-alpha="true" data-custom-width="0" />
                                    <button class="as-remove-bgGradient"><i class="fa fa-minus"></i></button>
                                </div>
                            </div>
                            <?php                             
                        }
                    ...
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">
                            <input class="as-slide-gradientAngle as-text-number as-pro-version" readonly="readonly" type="text" onkeypress="return avsIsNumberKey(event);" value="<?php echo $bggradient_angle; ?>" min="0" />
                ...
                <div class="as-bgtype-image">
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">
                            <button data-source="<?php echo $bgimage_src; ?>" data-alt="<?php echo $bgimage_alt; ?>" class="as-btn as-btn-default as-slide-bg-image"><?php _e('Select Image', 'avartan-slider-lite'); ?></button>
                        </div>
                    ...
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">
                            <input type="text" readonly="readonly" class="as-slide-alter-text as-pro-version" value="<?php echo $bgimage_alt; ?>" placeholder="<?php esc_attr_e('Alter Text', 'avartan-slider-lite'); ?>"/>
                        </div>
                    ...
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">
                            <input type="text" readonly="readonly" class="as-slide-image-title as-pro-version" value="<?php echo $bgimage_title; ?>" placeholder="<?php esc_attr_e('Image Title', 'avartan-slider-lite'); ?>"/>
                        </div>
                    ...
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control as-slide-bgpos-p" style="<?php echo $disp_position; ?>">
                            <input class="as-slide-bgpos-x" type="number" onkeypress="return avsIsNumberKey(event);" name="bg_position_x" value="<?php echo $bgimage_posx; ?>" max='100' min="0">
                        </div>
                        <div class="as-form-control as-slide-bgpos-p" style="<?php echo $disp_position; ?>">
                            <input class="as-slide-bgpos-y" type="number" onkeypress="return avsIsNumberKey(event);" name="bg_position_y" value="<?php echo $bgimage_posy; ?>" max='100' min="0">
                        </div>
                    ...
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control as-slide-bgsize-p" style="<?php echo $disp_size; ?>">
                            <input class="as-slide-bgsize-x" type="number" onkeypress="return avsIsNumberKey(event);" value="<?php echo $bgimage_sizex; ?>" max='100' min="0" />
                        </div>
                        <div class="as-form-control as-slide-bgsize-p" style="<?php echo $disp_size; ?>">
                            <input class="as-slide-bgsize-y" type="number" onkeypress="return avsIsNumberKey(event);" value="<?php echo $bgimage_sizey; ?>" max='100' min="0" />
                        </div>
                ...
                <div class="as-bgtype-youTubeVideo" <?php echo $bg_yt; ?>>
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">
                            <input type="text" readonly="readonly" value="<?php echo $bgYSrc; ?>" class="as-slide-youtube-source as-video-source as-align-vmiddle as-pro-version" placeholder="<?php esc_attr_e('Youtube ID or URL', 'avartan-slider-lite'); ?>"/>
                        </div>
                        <button data-source="<?php echo $bgYPSrc; ?>" data-alt="<?php echo $bgYPAlt; ?>" data-title="<?php echo $bgYPTitle; ?>" class="as-video-poster as-pro-version"><?php _e('Set Poster', 'avartan-slider-lite'); ?></button>
                        <span class="option-desc"><?php _e('Example: iNJdPyoqt8U', 'avartan-slider-lite'); ?></span>
                    </div>
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">
                            <div class="as-toggle-indicator as-slide-video-forcecover as-pro-version" title="<?php esc_attr_e('Force Cover', 'avartan-slider-lite'); ?>">
                                ...
                                foreach ($slide_select_options['background']['boolean'] as $key => $value) {
                                    ...
                                    ?>
                                <input type="radio" name="bgvideo_forcecover" class="yt-bgvideo_forcecover as-pro-version" id="bgvideo_forcecover_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                    <label for="bgvideo_forcecover_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                    <?php
                                }
                                ?>
                            </div>
                            ...
                            <div class="video-setting-wrap">
                                ...
                                <?php
                                    ...
                                    foreach ($slide_select_options['background']['boolean'] as $key => $value) {
                                        ...
                                        ?>
                                        <input type="radio" name="slide_youtube_loop" class="as-slide-video-loop as-pro-version" id="slide_youtube_loop_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                        <label for="slide_youtube_loop_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                        <?php
                                    }
                                    ?>
                                </div>
                            ...
                            <div class="video-setting-wrap">
                                ...
                                <?php
                                    ...
                                    foreach ($slide_select_options['background']['boolean'] as $key => $value) {
                                        ...
                                        ?>
                                        <input type="radio" name="slide_youtube_next_slide" class="as-slide-next-slide-on-video-end as-pro-version" id="slide_youtube_next_slide_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                        <label for="slide_youtube_next_slide_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                        <?php
                                    }
                                    ?>
                                </div>
                            ...
                            <div class="video-setting-wrap">
                                ...
                                <?php
                                    ...
                                    foreach ($slide_select_options['background']['boolean'] as $key => $value) {
                                        ...
                                        ?>
                                        <input type="radio" name="slide_youtube_force_rewind" class="as-slide-video-force-rewind as-pro-version" id="slide_youtube_force_rewind_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                        <label for="slide_youtube_force_rewind_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                        <?php
                                    }
                                    ?>
                                </div>
                            ...
                            <div class="video-setting-wrap">
                                ...
                                <?php
                                    ...
                                    foreach ($slide_select_options['background']['boolean'] as $key => $value) {
                                        ...
                                        ?>
                                        <input type="radio" name="slide_youtube_video_mute" class="as-slide-video-mute as-pro-version" id="slide_youtube_video_mute_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                        <label for="slide_youtube_video_mute_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                        <?php
                                    }
                                    ?>
                                </div>
                ...
                <div class="as-bgtype-vimeoVideo">
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">
                            <input type="text" readonly="readonly" value="<?php echo $bgVSrc; ?>" class="as-slide-vimeo-source as-video-source as-pro-version" placeholder="<?php esc_attr_e('Vimeo ID or URL', 'avartan-slider-lite'); ?>"/>
                        </div>
                        <button data-source="<?php echo $bgVPSrc; ?>" data-alt="<?php echo $bgVPAlt; ?>" data-title="<?php echo $bgVPTitle; ?>" class="as-video-poster as-pro-version"><?php _e('Set Poster', 'avartan-slider-lite'); ?></button>
                        ...
                        <div class="as-form-control">
                            <div class="as-toggle-indicator as-slide-vimeo-forcecover as-pro-version" title="<?php esc_attr_e('Force Cover', 'avartan-slider-lite'); ?>">
                                ...
                                foreach ($slide_select_options['background']['boolean'] as $key => $value) {
                                    ...
                                    ?>
                                <input type="radio" name="vimeo_forcecover" class="vimeo_forcecover as-pro-version" id="vimeo_forcecover_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                    <label for="vimeo_forcecover_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                    <?php
                                }
                                ?>
                            </div>
                            ...
                            <div class="video-setting-wrap">
                                ...
                                <?php
                                    ...
                                    foreach ($slide_select_options['background']['boolean'] as $key => $value) {
                                        ...
                                        ?>
                                        <input type="radio" name="slide_vimeo_loop" class="as-slide-video-loop as-pro-version" id="slide_vimeo_loop_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                        <label for="slide_vimeo_loop_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                        <?php
                                    }
                                    ?>
                                </div>
                            ...
                            <div class="video-setting-wrap">
                                ...
                                <?php
                                    ...
                                    foreach ($slide_select_options['background']['boolean'] as $key => $value) {
                                        ...
                                        ?>
                                        <input type="radio" name="slide_vimeo_next_slide" class="as-slide-next-slide-on-video-end as-pro-version" id="slide_vimeo_next_slide_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                        <label for="slide_vimeo_next_slide_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                        <?php
                                    }
                                    ?>
                                </div>
                            ...
                            <div class="video-setting-wrap">
                                ...
                                <?php
                                    ...
                                    foreach ($slide_select_options['background']['boolean'] as $key => $value) {
                                        ...
                                        ?>
                                        <input type="radio" name="slide_vimeo_force_rewind" class="as-slide-video-force-rewind as-pro-version" id="slide_vimeo_force_rewind_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                        <label for="slide_vimeo_force_rewind_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                        <?php
                                    }
                                    ?>
                                </div>
                            ...
                            <div class="video-setting-wrap">
                                ...
                                <?php
                                    ...
                                    foreach ($slide_select_options['background']['boolean'] as $key => $value) {
                                        ...
                                        ?>
                                        <input type="radio" name="slide_vimeo_video_mute" class="as-slide-video-mute as-pro-version" id="slide_vimeo_video_mute_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                        <label for="slide_vimeo_video_mute_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                        <?php
                                    }
                                    ?>
                                </div>
                ...
                <div class="as-bgtype-htmlVideo">
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">
                            <input type="text" readonly="readonly" value="<?php echo $bgHMp4; ?>" class="as-slide-mp4-source as-video-source as-pro-version" placeholder="<?php esc_attr_e('MP4', 'avartan-slider-lite'); ?>" title="<?php esc_attr_e('MP4', 'avartan-slider-lite'); ?>"/>
                        </div>
                    ...
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">
                            <input type="text" readonly="readonly" value="<?php echo $bgHWebm; ?>" class="as-slide-webm-source as-video-source as-pro-version" placeholder="<?php esc_attr_e('WEBM', 'avartan-slider-lite'); ?>" title="<?php esc_attr_e('WEBM', 'avartan-slider-lite'); ?>"/>
                        </div>
                    ...
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">
                            <input type="text" readonly="readonly" value="<?php echo $bgHOgv; ?>" class="as-slide-ogv-source as-video-source as-pro-version" placeholder="<?php esc_attr_e('OGV', 'avartan-slider-lite'); ?>" title="<?php esc_attr_e('OGV', 'avartan-slider-lite'); ?>"/>
                        </div>
                    ...
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">
                            <input type="text" readonly="readonly" value="<?php echo $bgHPSrc; ?>" class="as-slide-html5-poster-url as-pro-version" placeholder="<?php esc_attr_e('Poster Image', 'avartan-slider-lite'); ?>" title="<?php esc_attr_e('Poster Image', 'avartan-slider-lite'); ?>"/>
                        </div>
                        <button data-source="<?php echo $bgHPSrc; ?>" data-alt="<?php echo $bgHPAlt; ?>" data-title="<?php echo $bgHPTitle; ?>" class="as-video-poster as-pro-version" title="<?php esc_attr_e('Set Poster', 'avartan-slider-lite'); ?>"><?php _e('Set Poster', 'avartan-slider-lite'); ?></button>
                        ...
                        <div class="as-form-control">
                            <div class="as-toggle-indicator as-slide-htmlvideo-forcecover as-pro-version" title="<?php esc_attr_e('Force Cover', 'avartan-slider-lite'); ?>">
                                ...
                                foreach ($slide_select_options['background']['boolean'] as $key => $value) {
                                    ...
                                    ?>
                                    <input type="radio" name="htmlvideo_forcecover" class="htmlvideo_forcecover as-pro-version" id="htmlvideo_forcecover_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                    <label for="htmlvideo_forcecover_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                    <?php
                                }
                                ?>
                            </div>
                            ...
                            <div class="video-setting-wrap">
                                ...
                                <?php
                                    ...
                                    foreach ($slide_select_options['background']['boolean'] as $key => $value) {
                                        ...
                                        ?>
                                        <input type="radio" name="slide_html5_loop" class="as-slide-video-loop as-pro-version" id="slide_html5_loop_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                        <label for="slide_html5_loop_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                        <?php
                                    }
                                    ?>
                                </div>
                            ...
                            <div class="video-setting-wrap">
                                ...
                                <?php
                                    ...
                                    foreach ($slide_select_options['background']['boolean'] as $key => $value) {
                                        ...
                                        ?>
                                        <input type="radio" name="slide_html5_next_slide" class="as-slide-next-slide-on-video-end as-pro-version" id="slide_html5_next_slide_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                        <label for="slide_html5_next_slide_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                        <?php
                                    }
                                    ?>
                                </div>
                            ...
                            <div class="video-setting-wrap">
                                ...
                                <?php
                                    ...
                                    foreach ($slide_select_options['background']['boolean'] as $key => $value) {
                                        ...
                                        ?>
                                        <input type="radio" name="slide_html5_force_rewind" class="as-slide-video-force-rewind as-pro-version" id="slide_html5_force_rewind_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                        <label for="slide_html5_force_rewind_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                        <?php
                                    }
                                    ?>
                                </div>
                            ...
                            <div class="video-setting-wrap">
                                ...
                                <?php
                                    ...
                                    foreach ($slide_select_options['background']['boolean'] as $key => $value) {
                                        ...
                                        ?>
                                        <input type="radio" name="slide_html5_video_mute" class="as-slide-video-mute as-pro-version" id="slide_html5_video_mute_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                        <label for="slide_html5_video_mute_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                        <?php
                                    }
                                    ?>
                                </div>
            ...
            <div id='as_tab_kenburns' class="as-tab-info">
                ...
                <div class="as-form-control-group as-hide-ken-burns">
                    ...
                    <div class="as-form-control as-pro-version">
                        ...
                        <input type="text" readonly="readonly" value="<?php echo $kb_scale_start; ?>" name="as_slide_scale_start" class="as-slide-scale-start" onkeypress="return avsIsNumberKey(event);" style="min-width: 60px;width:60px;margin-right: 15px;">
                        <label style="width:20px"><?php _e('To', 'avartan-slider-lite'); ?></label>
                        <input type="text" readonly="readonly" value="<?php echo $kb_scale_end; ?>" name="as_slide_scale_end" class="as-slide-scale-end" onkeypress="return avsIsNumberKey(event);" style="width:60px;min-width: 60px;">
                    </div>
                </div>
                <div class="as-form-control-group as-hide-ken-burns">
                    ...
                    <div class="as-form-control as-pro-version">
                        <label style="width:40px"><?php _e('From', 'avartan-slider-lite'); ?></label>
                        <input type="text" readonly="readonly" value="<?php echo $kb_horizontal_from; ?>" name="as_slide_horizontal_offset_from" class="as-slide-horizontal-offset-from" onkeypress="return avsIsNumberKey(event);" style="min-width: 60px;width:60px;margin-right: 15px;">
                        <label style="width:20px"><?php _e('To', 'avartan-slider-lite'); ?></label>
                        <input type="text" readonly="readonly" value="<?php echo $kb_horizontal_to; ?>" name="as_slide_horizontal_offset_to" class="as-slide-horizontal-offset-to" onkeypress="return avsIsNumberKey(event);" style="width:60px;min-width: 60px;">
                    </div>
                </div>
                <div class="as-form-control-group as-hide-ken-burns">
                    ...
                    <div class="as-form-control as-pro-version">
                        <label style="width:40px"><?php _e('From', 'avartan-slider-lite'); ?></label>
                        <input type="text" readonly="readonly" value="<?php echo $kb_vertical_from; ?>" name="as_slide_vertical_offset_from" class="as-slide-vertical-offset-from" onkeypress="return avsIsNumberKey(event);" style="min-width: 60px;width:60px;margin-right: 15px;">
                        <label style="width:20px"><?php _e('To', 'avartan-slider-lite'); ?></label>
                        <input type="text" readonly="readonly" value="<?php echo $kb_vertical_to; ?>" name="as_slide_vertical_offset_to" class="as-slide-vertical-offset-to" onkeypress="return avsIsNumberKey(event);" style="width:60px;min-width: 60px;">
                    </div>
                </div>
                <div class="as-form-control-group as-hide-ken-burns">
                    ...
                    <div class="as-form-control as-pro-version">
                        <label style="width:40px"><?php _e('From', 'avartan-slider-lite'); ?></label>
                        <input type="text" value="<?php echo $kb_rotation_start; ?>" name="as_slide_rotation_start" class="as-slide-rotation-start" onkeypress="return avsIsNumberKey(event);" style="min-width: 60px;width:60px;margin-right: 15px;">
                        <label style="width:20px"><?php _e('To', 'avartan-slider-lite'); ?></label>
                        <input type="text" value="<?php echo $kb_rotation_end; ?>" name="as_slide_rotation_end" class="as-slide-rotation-end" onkeypress="return avsIsNumberKey(event);" style="width:60px;min-width: 60px;">
                    </div>
                </div>
                <div class="as-form-control-group as-hide-ken-burns">
                ...
                <div class="as-form-control-group as-hide-ken-burns">
                    ...
                    <div class="as-form-control">
                        <input class="as-slide-kenburn-easing-time as-text-number as-pro-version" type="text" readonly="readonly" value="<?php echo $kb_easing_time; ?>" onkeypress="return avsIsNumberKey(event);" min="0">
            ...
            <div id='as_tab_overlay' class="as-tab-info">
                <div class="as-form-control-group">
                    ...
                    <span class="option-desc"><?php _e('Set color overlay on background image or color. Default : transparent', 'avartan-slider-lite'); ?></span>
                </div>
                <div class="as-form-control-group as-overlay-solidcolor" <?php echo $bgoverlay_color; ?>>
                    ...
                    <div class="as-form-control as-pro-color">
                        <input type="text" readonly="readonly" value="<?php echo $bgcolor_overlay; ?>" class="as-slide-overlaySolidColor as-color-picker" data-alpha="true" data-custom-width="0" />
                    </div>
                ...
                <div class="as-overlay-gradientColor" <?php echo $bgoverlay_gd; ?>>
                    ...
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control as-pro-color">
                            <input type="text" readonly="readonly" value="<?php echo $detOColor1; ?>" class="as-slide-gradientOverlay as-color-picker" data-alpha="true" data-custom-width="0" />
                        </div>
                    ...
                    <div class="as-form-control-group as-gradient-block">
                        <label>&nbsp;</label>
                        <div class="as-form-control as-pro-color">
                            <input type="text" value="<?php echo $detOColor2; ?>" class="as-slide-gradientOverlay as-color-picker" data-alpha="true" data-custom-width="0" />
                            <button class="as-add-overlayGradient as-pro-version"><i class="fa fa-plus"></i></button>
                        </div>
                    </div>
                    <?php
                    if (isset($bgcolorOArr) && count($bgcolorOArr) > 2) {
                        for ($i = 2; $i < count($bgcolorOArr); $i++) {
                            ...
                            <div class="as-form-control-group as-gradient-block">
                                <label>&nbsp;</label>
                                <div class="as-form-control as-pro-color">
                                    <input type="text" value="<?php echo $bgcolorOArr[$i]; ?>" class="as-slide-gradientOverlay as-color-picker" data-alpha="true" data-custom-width="0" />
                                    <button class="as-remove-overlayGradient"><i class="fa fa-minus"></i></button>
                                </div>
                            </div>
                            <?php
                        }
                    ...
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">                            
                            <input class="as-slide-gradientOverlayAngle as-text-number as-pro-version" type="text" readonly="readonly" onkeypress="return avsIsNumberKey(event);" value="<?php echo $bggradient_overlay_angle; ?>" min="0" />
                ...
                <div class="as-form-control-group">
                    ...
                    <span class="option-desc"><?php _e('Set Pattern overlay on background image or color. Default : none', 'avartan-slider-lite'); ?></span>
                </div>
            </div>
        </div>
    </div>
