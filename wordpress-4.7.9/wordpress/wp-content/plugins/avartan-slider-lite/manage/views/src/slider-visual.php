        ...
        <div class="as-tab-info" id="as-tab-appearance">
            <div class="as-form as-form-horizontal">
                <div class="as-form-control-group">
                    ...
                    <div class="as-form-control">
                        <select id="as-slider-background-type-color" class="as-slider-bgcolor">
                            ...
                            <option value="1" <?php echo ($bg_type != '' && $bg_type != 'transparent') ? 'selected="selected"' : '' ?>><?php _e('Background Color', 'avartan-slider-lite'); ?></option>
                        </select>
                    </div>
                ...
                <div class="as-form-control-group as-slider-bg-colorpicker" <?php echo $display_bgcolor; ?>>
                    <label></label>
                    <div class="as-form-control">
                        <input type="text" id="as-slider-background-type-color-picker-input" value="<?php echo ($bg_type != '' && $bg_type != 'transparent') ? $bg_type : '' ?>" class="as-slider-bgcolorpicker as-color-picker" data-alpha="true" data-custom-width="0" />
                    </div>
                </div>
                <div class="as-form-control-group">
                    <label>
                ...
                <div class="as-form-control-group as-slider-shadow-img">
                    <label></label>
                    <div class="as-form-control">
                        <input class="as-slider-default-shadow as-button as-is-default" type="hidden" value="<?php esc_attr_e('Select Default Shadow', 'avartan-slider-lite'); ?>" data-shadow-class="<?php echo $shadow_style; ?>" />
                        <?php
//                        $shadow_path = plugins_url() . '/avartan-slider-lite/manage/assets/images/shadow/';
        ...
        <div class="as-tab-info" id="as-tab-mobile">
            <div class="as-form as-form-horizontal">
                <div class="as-form-control-group">
                    ...
                    <div class="as-form-control">
                        <input type="text" min="0" readonly="readonly" onkeypress="return avsIsNumberKey(event);" class="as-hide-slider as-text-number as-pro-version" value="<?php echo $slider_hide; ?>" />
                ...
                <div class="as-form-control-group">
                    ...
                    <div class="as-form-control">
                        <input type="text" min="0" readonly="readonly" onkeypress="return avsIsNumberKey(event);" class="as-hide-define-ele as-text-number as-pro-version" value="<?php echo $def_ele; ?>" />
                        <span class="lbl_px">px</span>
                    </div>
                ...
                <div class="as-form-control-group">
                    ...
                    <div class="as-form-control">
                        <input type="text" min="0" readonly="readonly" onkeypress="return avsIsNumberKey(event);" class="as-hide-all-ele as-text-number as-pro-version" value="<?php echo $ele_all; ?>" />
                        <span class="lbl_px">px</span>
                    </div>
                ...
                <div class="as-form-control-group">
                    ...
                    <div class="as-form-control">
                        <input type="text" min="0" readonly="readonly" onkeypress="return avsIsNumberKey(event);" class="as-hide-arrows as-text-number as-pro-version" value="<?php echo $arrow_hide; ?>" />
                        <span class="lbl_px">px</span>
                    </div>
                ...
                <div class="as-form-control-group">
                    ...
                    <div class="as-form-control">
                        <input type="text" min="0" readonly="readonly" onkeypress="return avsIsNumberKey(event);" class="as-hide-bullets as-text-number as-pro-version" value="<?php echo $bullet_hide; ?>" />
                        <span class="lbl_px">px</span>
                    </div>
                        ...
                        <div class="as-toggle-indicator as-timerbar-toggle as-pro-version" id="as-slider-showTimerBar">
                            <?php
                                foreach ($slider_select_options['boolean'] as $key => $value) {
                                    ...
                                    ?>
                            <input name="show_timer_bar" class="show-timer-bar" type="radio" id="show_timer_bar_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                    <label for="show_timer_bar_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                    <?php
                                }
                            ?>
                        </div>
