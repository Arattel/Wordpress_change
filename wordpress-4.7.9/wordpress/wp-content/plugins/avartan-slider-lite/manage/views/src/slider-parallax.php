...
<div class="as-form as-form-horizontal">
        ...
        <div class="as-form-control">
            <div class="as-toggle-indicator as-pro-version" id="as-slider-parallax-effect">
                ...
                foreach ($slider_select_options['boolean'] as $key => $value) {
                    ...
                    ?>
                    <input name="enable_parallax_3d" class="enable-parallax-3d <?php if($key == 1){ echo '1as-pro-version'; } ?>" type="radio" id="enable_parallax_3d_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                    <label for="enable_parallax_3d_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                    <?php
                }
                ?>
            </div>
    ...
    <div class="as-slide-parallax-setting" style="display: inline-block;width: 100%;">
            ...
            <div class="as-form-control">
                <div class="as-toggle-indicator as-pro-version" id="as-slider-parallax-3d-effect">
                    ...
                    foreach ($slider_select_options['boolean'] as $key => $value) {
                        ...
                        ?>
                        <input name="enable_3d" class="enable-3d" type="radio" id="enable_3d_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                        <label for="enable_3d_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                        <?php
                    }
                    ?>
                </div>
        ...
        <div class="as-form-control-group as-3d-effect-show">
            <span class="as-notice"><i class="fa fa-hand-o-right"></i><?php _e('3D Settings', 'avartan-slider-lite'); ?></span>
        </div>
        <div class="as-form-control-group as-3d-effect-show">
            ...
            <div class="as-form-control">
                <div class="as-toggle-indicator as-pro-version" id="as-slider-3d-shadow">
                    ...
                    foreach ($slider_select_options['boolean'] as $key => $value) {
                        ...
                        ?>
                        <input name="enable_3d_shadow" class="enable-3d-shadow" type="radio" id="enable_3d_shadow_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                        <label for="enable_3d_shadow_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                        <?php
                    }
                    ?>
                </div>
            ...
            <div class="as-form-control">
                <div class="as-toggle-indicator as-pro-version">
                    ...
                    foreach ($slider_select_options['boolean'] as $key => $value) {
                        ...
                        ?>
                        <input name="enable_3d_background" class="enable-3d-background" type="radio" id="enable_3d_background_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                        <label for="enable_3d_background_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                        <?php
                    }
                    ?>
                </div>
            ...
            <div class="as-form-control">
                <div class="as-toggle-indicator as-pro-version">
                    ...
                    foreach ($slider_select_options['boolean'] as $key => $value) {
                        ...
                        ?>
                        <input name="enable_slider_overflow_hidden" class="enable-slider-overflow-hidden" type="radio" id="enable_slider_overflow_hidden_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                        <label for="enable_slider_overflow_hidden_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                        <?php
                    }
                    ?>
                </div>
            ...
            <div class="as-form-control">
                <div class="as-toggle-indicator as-pro-version">
                    ...
                    foreach ($slider_select_options['boolean'] as $key => $value) {
                        ...
                        ?>
                        <input name="enable_layer_overflow_hidden" class="enable-layer-overflow-hidden" type="radio" id="enable_layer_overflow_hidden_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                        <label for="enable_layer_overflow_hidden_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                        <?php
                    }
                    ?>
                </div>
        ...
        <div class="as-form-control-group as-3d-effect-show">
            ...
            <div class="as-form-control">
                <input type="text" min="0" readonly="readonly" onkeypress="return avsIsNumberKey(event);" class="as-slider-default-3d-depth as-text-number as-pro-version" value="<?php echo $default_3d_depth; ?>" />
                <span class="lbl_px">px</span>
            </div>
        </div>
        <div class="as-form-control-group">
            <span class="as-notice"><i class="fa fa-hand-o-right"></i><?php _e('Mouse Sensibility', 'avartan-slider-lite'); ?></span>
        </div>
        ...
        <div class="as-form-control-group">
            ...
            <div class="as-form-control">
                <input type="text" min="0" readonly="readonly" onkeypress="return avsIsNumberKey(event);" class="as-pro-version as-slider-parallax-animation-speed as-text-number" value="<?php echo $slider_parallax_animation_speed; ?>" />
        ...
        <div class="as-form-control-group">
            <span class="as-notice"><i class="fa fa-hand-o-right"></i><?php _e('Parallax Levels', 'avartan-slider-lite'); ?></span>
        </div>
        <?php
        $parallax_depth = 0;
        for ($x = 1; $x <= 15; $x++) {
            ...
            <div class="as-form-control-group">
                ...
                <div class="as-form-control">
                    <input type="text" min="0" readonly="readonly" onkeypress="return avsIsNumberKey(event);" class="as-pro-version as-slider-parallax-depth-<?php echo $x; ?> as-text-number" value="<?php echo AvartanSliderLiteFunctions::getVal($parallax_options,$db_name,$parallax_depth); ?>" />
                </div>
                <?php if($x == 1) { ?>
