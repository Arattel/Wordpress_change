        ...
        <div class="as-tab-info" id="as-tab-arrows">
            <div class="as-form as-form-horizontal">
                <div class="as-form-control-group">
                    ...
                    <div class="as-form-control">
                        <div class="as-toggle-indicator as-nav-arrows-toggle" id="as-slider-enableArrows">
                            ...
                            foreach ($slider_select_options['boolean'] as $key => $value) {
                                ...
                                ?>
                            <input name="enable_navigation" class="enable-navigation" type="radio" id="enable_navigation_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                <label for="enable_navigation_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                <?php
                            }
                    ...
                    <span class="option-desc"><?php _e('Show the navigation arrows on slider. Note : In Avartan Slider Lite plugin we are providing images for arrow and in Avartan Slider Pro plugin we are providing CSS3 arrow.', 'avartan-slider-lite'); ?></span>
                </div>
                <div class="as-tab-arrows-enabled">
                    ...
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">
                            <div class="as-selected-arrow-style">
                                <input type="hidden" class="as-arrow-style-hidden" value="<?php echo $aStyle; ?>" />
                            ...
                            if ($total_arrows > 0) {
                                foreach ($slider_select_options['arrows'] as $key => $arrows) {
                                    ...
                                    <div class="as-dialog-arrow-style">
                                        <input type="hidden" class="as-arrows-style-hidden" value="<?php echo $key; ?>" />
                                        <div class="as-nav-arrows">
                                            <?php echo $arrows; ?>
                                        </div>
                                    </div>
                    ...
                    <div class="as-form-control-group">
                        <span class="as-notice"><i class="fa fa-hand-o-right"></i> <?php _e('Left Arrow', 'avartan-slider-lite'); ?></span>
                    </div>
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control as-pro-version">
                            <div class="as-toggle-indicator as-left-hpos-toggle" id="as-left-hpos-toggle">
                                ...
                                foreach ($slider_select_options['navHPosition'] as $key => $value) {
                                    ...
                                    ?>
                                <input type="radio" name="left_hpos" class="left-hpos" id="left_hpos_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?> />
                                <label class="<?php echo $active; ?>" for="left_hpos_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                    <?php
                                }
                                ?>
                            </div>
                        ...
                        <div class="as-form-control as-pro-version">
                            <div class="as-toggle-indicator as-left-vpos-toggle" id="as-left-vpos-toggle">
                                ...
                                foreach ($slider_select_options['navVPosition'] as $key => $value) {
                                    ...
                                    ?>
                                    <input type="radio" name="left_vpos" class="left-vpos" id="left_vpos_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?> />
                                    <label class="<?php echo $active; ?>" for="left_vpos_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                    <?php
                                }
                                ?>
                            </div>
                    ...
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">
                            <input class="as-slider-arrowLHOffset as-text-number as-pro-version" value="<?php echo $lhOffset; ?>" type="text" readonly="readonly" value="0" onkeypress="return avsIsNumberKey(event);" min="0" />
                    ...
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">
                            <input class="as-slider-arrowLVOffset as-text-number as-pro-version" value="<?php echo $lvOffset; ?>" type="text" readonly="readonly" value="0" onkeypress="return avsIsNumberKey(event);" min="0" />
                            <span class="lbl_px">px</span>
                        </div>
                        <span class="option-desc"><?php _e('Set vertical offset for left arrow.', 'avartan-slider-lite'); ?></span>
                    </div>
                    <div class="as-form-control-group">
                        <span class="as-notice"><i class="fa fa-hand-o-right"></i> <?php _e('Right Arrow', 'avartan-slider-lite'); ?></span>
                    </div>
                    <div class="as-form-control-group">
                        <label><?php _e('Horizontal Position', 'avartan-slider-lite'); ?></label>
                        <div class="as-form-control as-pro-version">
                            <div class="as-toggle-indicator as-right-hpos-toggle" id="as-right-hpos-toggle">
                                ...
                                foreach ($slider_select_options['navHPosition'] as $key => $value) {
                                    ...
                                    ?>
                                    <input type="radio" name="right_hpos" class="right-hpos" id="right_hpos_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?> />
                                    <label class="<?php echo $active; ?>" for="right_hpos_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                    <?php
                                }
                                ?>
                            </div>
                        ...
                        <div class="as-form-control as-pro-version">
                            <div class="as-toggle-indicator as-right-vpos-toggle" id="as-right-vpos-toggle">
                                ...
                                foreach ($slider_select_options['navVPosition'] as $key => $value) {
                                    ...
                                    ?>
                                    <input type="radio" name="right_vpos" class="right-vpos" id="right_vpos_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?> />
                                    <label class="<?php echo $active; ?>" for="right_vpos_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                    <?php
                                }
                                ?>
                            </div>
                    ...
                    <div class="as-form-control-group">
                        <label><?php _e('Horizontal Offset', 'avartan-slider-lite'); ?></label>
                        <div class="as-form-control">
                            <input class="as-slider-arrowRHOffset as-text-number as-pro-version" value="<?php echo $rhOffset; ?>" type="text" readonly="readonly" value="0" onkeypress="return avsIsNumberKey(event);" min="0" />
                            <span class="lbl_px">px</span>
                        </div>
                    ...
                    <div class="as-form-control-group">
                        <label><?php _e('Vertical Offset', 'avartan-slider-lite'); ?></label>
                        <div class="as-form-control">
                            <input class="as-slider-arrowRVOffset as-text-number as-pro-version" value="<?php echo $rvOffset; ?>" type="text" readonly="readonly" value="0" onkeypress="return avsIsNumberKey(event);" min="0" />
                            <span class="lbl_px">px</span>
                        </div>
            ...
            <div class="as-form as-form-horizontal">
                    ...
                    <div class="as-form-control">
                        <div class="as-toggle-indicator as-nav-bullets-toggle">
                            ...
                            foreach ($slider_select_options['boolean'] as $key => $value) {
                                ...
                                ?>
                                <input name="enable_nav_bullets" class="enable-nav-bullets" type="radio" id="enable_nav_bullets_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                <label for="enable_nav_bullets_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                <?php
                            }
                            ?>
                        </div>
                ...
                <div class="as-tab-bullets-enabled" <?php echo $navBulletStyle; ?>>
                    ...
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">
                            <div class="as-selected-bullet-style">
                                <input type="hidden" class="as-bullet-style-hidden" value="<?php echo $bulletStyle; ?>" />
                            ...
                            if ($total_bullets > 0) {
                                foreach ($slider_select_options['bullets'] as $key => $bullets_val) {
                                    ...
                                    <div class="as-dialog-bullet-style">
                                        <input type="hidden" class="as-bullet-style-hidden" value="<?php echo $key; ?>" />
                                        <div class="as-bullets-wrap">
                    ...
                    <div class="as-form-control-group" <?php echo $navBulletStyle; ?>>
                        ...
                        <div class="as-form-control">
                            <input class="as-bullet-gap as-text-number as-pro-version" type="text" onkeypress="return avsIsNumberKey(event);" min="0" value="<?php echo $bgap; ?>">
                            <span class="lbl_px">px</span>
                        </div>
                        ...
                        <div class="as-form-control">
                            <div class="as-toggle-indicator as-bullet-hpos-toggle" id="as-bullet-hpos-toggle">
                                ...
                                foreach ($slider_select_options['navHPosition'] as $key => $value) {
                                    ...
                                    ?>
                                    <input type="radio" name="bullet_hpos" class="bullet-hpos" id="bullet_hpos_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?> />
                                    <label class="<?php echo $active; ?>" for="bullet_hpos_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                    <?php
                                }
                                ?>
                            </div>
                        ...
                        <div class="as-form-control as-pro-version">
                            <div class="as-toggle-indicator as-bullet-vpos-toggle" id="as-bullet-vpos-toggle">
                                ...
                                foreach ($slider_select_options['navVPosition'] as $key => $value) {
                                    ...
                                    ?>
                                    <input type="radio" name="bullet_vpos" class="bullet-vpos" id="bullet_vpos_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?> />
                                    <label for="bullet_vpos_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                    <?php
                                }
                                ?>
                            </div>
                    ...
                    <div class="as-form-control-group">
                        <label><?php _e('Horizontal Offset', 'avartan-slider-lite'); ?></label>
                        <div class="as-form-control">
                            <input class="as-bullet-horizontal-offset as-text-number as-pro-version" readonly="readonly" value="<?php echo $hOffset; ?>" type="text" value="0" onkeypress="return avsIsNumberKey(event);" min="0">
                            <span class="lbl_px">px</span>
                        </div>
                    ...
                    <div class="as-form-control-group">
                        <label><?php _e('Vertical Offset', 'avartan-slider-lite'); ?></label>
                        <div class="as-form-control">
                            <input class="as-bullet-verticle-offset as-text-number as-pro-version" readonly="readonly" value="<?php echo $vOffset; ?>" type="text" value="0" onkeypress="return avsIsNumberKey(event);" min="0">
                            <span class="lbl_px">px</span>
                        </div>
