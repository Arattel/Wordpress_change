                        ...
                        <div class="as-toggle-indicator as-automaticSlide-toggle" id="as-slider-automaticSlide">
                            <?php
                                foreach ($slider_select_options['boolean'] as $key => $value) {
                                    ...
                                    ?>
                                    <input name="automatic_slide" class="automatic-slide" type="radio" id="automatic_slide_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                    <label for="automatic_slide_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                    <?php
                                }
                            ?>
                        </div>
                        ...
                        <div class="as-toggle-indicator as-randomSlide-toggle as-pro-version" id="as-slider-randomSlide">
                            <?php
                                foreach ($slider_select_options['boolean'] as $key => $value) {
                                    ...
                                    ?>
                                    <input name="random_slide" class="random-slide" type="radio" id="random_slide_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                    <label for="random_slide_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                    <?php
                                }
                            ?>
                        </div>
                        ...
                        <div class="as-toggle-indicator as-pauseOnHover-toggle" id="as-slider-pauseOnHover">
                            <?php
                                foreach ($slider_select_options['boolean'] as $key => $value) {
                                    ...
                                    ?>
                                    <input name="pause_on_hover_slide" class="pause-on-hover-slide" type="radio" id="pause_on_hover_slide_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                    <label for="pause_on_hover_slide_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                    <?php
                                }
                            ?>
                        </div>
                        ...
                        <div class="as-toggle-indicator as-swipeDrag-toggle" id="as-slider-enableSwipe">
                            <?php
                                foreach ($slider_select_options['boolean'] as $key => $value) {
                                    ...
                                    ?>
                                    <input name="enable_swipe" class="enable-swipe" type="radio" id="enable_swipe_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                    <label for="enable_swipe_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                    <?php
                                }
                            ?>
                        </div>
                        ...
                        <div class="as-toggle-indicator as-loader-toggle" id="as-slider-enableLoader">
                            <?php
                                foreach ($slider_select_options['boolean'] as $key => $value) {
                                    ...
                                    ?>
                                    <input name="enable_loader" class="enable-loader <?php if($key == 0){ echo 'as-pro-version'; } ?>" type="radio" id="enable_loader_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                                    <label for="enable_loader_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                    <?php
                                }
                            ?>
                        </div>
                    ...
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control">
                            <div class="as-selected-loader-style" style="<?php echo $lHtml == '' ? 'display:none;' : 'display:table;' ?>">
                                <input type="hidden" class="as-loader-style-hidden" value="<?php echo $lStyle; ?>" />
                            ...
                            if ($total_bullets > 0) {
                                foreach ($slider_select_options['loaders'] as $key => $loader_html) {
                                    ...
                                    <div class="as-dialog-loader-style">
                                        <input type="hidden" class="as-loader-style-hidden" value="<?php echo $key; ?>" />
                                        <div class="as-loader-style-html">
                ...
                <div class="as-loader-img">
                    <div class="as-form-control-group">
                        ...
                        <div class="as-form-control as-pro-version">
                            <a class="as-btn as-btn-default as-loaderImg" href="javascript:void(0);" data-width="<?php echo $lWidth; ?>" data-height="<?php echo $lHeight; ?>"><?php _e('Change Loader Image', 'avartan-slider-lite'); ?></a>
                        </div>
                    </div>
                    <div class="as-form-control-group">
                        <label>&nbsp;</label>
                        <div class="as-form-control">
                            <input type="hidden" class="as-loader-img-hidden" value="<?php echo $lImage; ?>" />
                            <?php if ($lImage != '') { ?>
