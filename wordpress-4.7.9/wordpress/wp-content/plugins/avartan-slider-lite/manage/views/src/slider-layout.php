...
<div class="as-form as-form-horizontal">
        ...
        <div class="as-form-control">
            <div class="as-toggle-indicator as-sliderLayout-toggle">
                ...
                foreach ($slider_select_options['layout'] as $key => $value) {
                    ...
                    ?>
                    <input type="radio" name="as-layout-button" class="as-layout-button <?php echo $class; ?>" id="layout_button_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                    <label for="layout_button_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                    <?php
                }
                ?>
            </div>
        ...
        <div class="as-form-control as-pro-version">
            <div class="as-toggle-indicator as-forceFullWidth-toggle">
                ...
                foreach ($slider_select_options['boolean'] as $key => $value) {
                    ...
                    ?>
                    <input type="radio" name="force_to_fullwidth" class="force-to-fullwidth" id="force_full_width_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?>/>
                    <label for="force_full_width_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                    <?php
                }
                ?>
            </div>
    ...
    <div class="as-form-control-group">
        <span class="as-notice"><i class="fa fa-hand-o-right"></i> <?php _e('Layer Grid Size', 'avartan-slider-lite'); ?></span>
    </div>
    <div class="as-form-control-group">
        <div class="as-layout-grid-wrap">
            <div class="as-layout-grid">
                ...
                <div class="as-form-control-group as-layout-width">
                    <div class="as-form-control as-screensize-txtbox">
                        <input type="text" class="as-layout-grid-textbox as-slider-startWidth as-text-number" value="<?php echo $start_width; ?>" maxlength="5" onkeypress="return avsIsNumberKey(event);"/>
                        <span class="lbl_px">px</span>
                    </div>
                    <span class="as-layout-measure">X</span>
                    <div class="as-form-control as-screensize-txtbox">
                        <input type="text" class="as-layout-grid-textbox as-slider-startHeight as-text-number" value="<?php echo $start_height; ?>" maxlength="5" onkeypress="return avsIsNumberKey(event);"/>
                        <span class="lbl_px">px</span>
                    </div>
                </div>
            </div>
            <div class="as-layout-grid">
                ...
                <div class="as-form-control-group as-layout-width">
                    <div class="as-form-control as-screensize-txtbox">
                        <input type="text" readonly="readonly" class="as-pro-version as-layout-grid-textbox as-slider-mobileGridWidth as-text-number" maxlength="5" value="<?php echo $mobile_grid_width; ?>" onkeypress="return avsIsNumberKey(event);"/>
                        <span class="lbl_px">px</span>
                    </div>
                    <span class="as-layout-measure">X</span>
                    <div class="as-form-control as-screensize-txtbox">
                        <input type="text" readonly="readonly" class="as-pro-version as-layout-grid-textbox as-slider-mobileGridHeight as-text-number" maxlength="5" value="<?php echo $mobile_grid_height; ?>" onkeypress="return avsIsNumberKey(event);"/>
                        <span class="lbl_px">px</span>
                    </div>
                </div>
                <div class="as-form-control-group">
                    ...
                    <div class="as-form-control">
                        <div class="as-toggle-indicator as-custom-design-toggle as-pro-version" id="as-slider-mobileCustomSize">
                            ...
                            foreach ($slider_select_options['boolean'] as $key => $value) {
                                ...
                                ?>
                                <input name="mobile_custom_design" class="mobile-custom-design as-pro-version" type="radio" id="mobile_custom_design_<?php echo $key; ?>" value="<?php echo $key; ?>" <?php echo $checked; ?> />
                                <label for="mobile_custom_design_<?php echo $key; ?>"><?php echo $value[0]; ?></label>
                                <?php
                            }
                            ?>
                        </div>
