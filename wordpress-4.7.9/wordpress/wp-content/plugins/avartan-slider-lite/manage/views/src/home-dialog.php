    ...
    <div class="as-dialog-tabs">
        ...
        <div class="as-tabs-content">
            ...
            <div class="as-tab-info as-text-center" id="as_tab_new_slider">
                ...
                <a class="as-slider-build-block active" title="<?php esc_attr_e( 'Standard Slider', 'avartan-slider-lite' ); ?>" href="?page=avartanslider&view=slider&slider_type=standard-slider">
                        ...
                        foreach ($default_template as $template => $template_value) {
                            ...
                            <div class="as-template-wrapper">
                                ...
                                <div class="as-template-desc">
                                    ...
                                    <a class="as-template-icon as-download-default-template as-pro-version" href="javascript:void(0)"><i class="fa fa-download"></i></a>
                                    <a href="<?php echo $template_value['link']; ?>" target="_blank" class="as-template-icon"><i class="fa fa-search"></i></a>
                                </div>
                            </div>
                            <?php                            
                        }                        
